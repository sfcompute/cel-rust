...
pub enum Expr {
    ...
    /// BindKind represents a variable binding expression (cel.bind macro).
    Bind(Box<BindExpr>),
...
pub struct BindExpr {
    ...
    pub var: String,
    /// The initialization expression (evaluated once)
    pub init: IdedExpr,
    /// The result expression (evaluated with var in scope)
    pub result: IdedExpr,
}
